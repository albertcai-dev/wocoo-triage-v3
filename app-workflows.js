...
function TriageWorkflow(props){var ticket=props.ticket,onClose=props.onClose;
  ...
  var isCCOvpType=(ticket.type||"").toLowerCase().indexOf("credit card: overpayment")!==-1;var approver=manualApprover||(amount&&amount>=5000?APPROVERS.amanda:APPROVERS.luke);var meetsMinimum=amount&&amount>=1000;var isFraudPath=!!(amount&&amount>FRAUD_AMOUNT_THRESHOLD);var fraudSummary="Suspected fraud — credit card overpayment of "+fmtAmt(amount)+" ("+ticket.id+")";var accountIdValid=ACCOUNT_ID_RE.test(accountId);var presetUrl="https://8a26d867.wealthsimple-aws-mpc.app.preset.io/superset/dashboard/5790/?native_filters_key=oC5oWi8scg3klJL4tQV7iek7_rpp1Y0F0BiDXhwAh3H1WzLbrFAA7MAw91A60PJn";
